...
inline const std::string& PingRequest::message() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:PingRequest.message)
...
inline PROTOBUF_ALWAYS_INLINE void PingRequest::set_message(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:PingRequest.message)
}
inline std::string* PingRequest::mutable_message() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_message();
  // @@protoc_insertion_point(field_mutable:PingRequest.message)
  return _s;
}
...
inline std::string* PingRequest::release_message() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:PingRequest.message)
...
inline void PingRequest::set_allocated_message(std::string* value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:PingRequest.message)
}
...
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void PingResponse::set_reply(Arg_&& arg,
                                                     Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.reply_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:PingResponse.reply)
}
inline std::string* PingResponse::mutable_reply() ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline void PingResponse::set_allocated_reply(std::string* value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
